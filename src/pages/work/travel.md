...
slug: 'travel'
order: 3
summary: "Saving the company millions of dollars through reduced employee effort on critical booking tasks. I led the research, workshop, and design sessions of MyBooking, the corporate travel application for Morgan Stanley. The travel website was heavily used by corporate employees, and the redesign was said to be a relief from their single biggest source of frustration in their work."
---

# Reinventing travel <br>across the firm.
...
<figure class="medium"> 
  <img src="/work/travel/thumb.jpg" />
  <figcaption>The travel website was heavily used by corporate employees, and the redesign was said to be a relief from their single biggest source of frustration in their work.</figcaption>
</figure>
...
<figure class="large"> 
  <img src="/work/travel/sharing.jpg" />
  <figcaption>Search patterns merged industry standards with corporate interests, which are more specific to corporate and employee goals.</figcaption>
</figure>
...
<figure class="large"> 
  <img src="/work/travel/hotel.jpg" />
  <figcaption>MyBooking keeps all the information you need before, during, and after your trip. This system worked well for flight commuters who were repeating the same routes on a regular schedule, for frequent fliers who traveled to new destinations, and for occasional travelers.</figcaption>
</figure>
...
<div class="panzoom">
  <div id="viewer">
    <img
      id="image"
      src="/work/travel/templates2.png"
      alt="Zoomable"
      draggable="false"
    />
  </div>
</div>
<div class="zoomcaption">Reusable layouts and components were a critical source of saving development time, which allowed us to reduce the development time by months.</div>
...
<figure class="medium"> 
  <img src="/work/travel/add.jpg" />
  <figcaption>MyBooking manages the users flights, hotels, rental cars, and trains. We were able to integrate a thick set of requirements across several lines of travel while reducing complexity of the overall system.</figcaption>
</figure>
